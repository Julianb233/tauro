          ...
          <div className="flex items-center gap-1 sm:gap-3">
            <GoldShimmer>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-md p-2 text-white/70 transition-all duration-300 hover:text-gold hover:scale-110"
