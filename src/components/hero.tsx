  ...
  return (
    <section aria-label="Hero" className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-24 text-center sm:px-6 sm:py-32 lg:px-8">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base text-white/95 sm:mt-6 sm:text-lg">
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/home-value"
            className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/10 px-6 py-4 font-label text-sm font-medium uppercase tracking-wider text-white backdrop-blur-sm transition-all duration-300 hover:border-gold/50 hover:text-gold"
          >
            Get Your Home Value
          </Link>
        </div>
