...
export function LogoConcept1({
  ...
  const bg = variant === "light" ? "#1A1A2E" : "#F8F6F1";
  ...
  return (
    ...
    >
      ...
      <g fill={primary}>
        ...
        {/* Negative-space bull head cut out */}
        <path
        ...
        />
        {/* Subtle nostrils */}
        <circle cx="38" cy="36" r="1" fill={bg} opacity="0.4" />
        <circle cx="42" cy="36" r="1" fill={bg} opacity="0.4" />
        {/* Nose bridge */}
        <line
