...
function ImageCarousel({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "absolute top-3 left-3 z-10 rounded-md px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-white",
      ...
      {/* ---- photo count ---- */}
      <span className="absolute right-3 bottom-3 z-10 rounded-md bg-black/60 px-2 py-1 text-xs text-white backdrop-blur-sm">
        {total} photos
      </span>
