...
export const buyerFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Closing costs typically range from 2-5% of the purchase price. They include lender fees (origination, appraisal, credit report), title insurance, attorney fees, transfer taxes, recording fees, and prepaid items like homeowner's insurance and property taxes. In Philadelphia, the buyer's share of the transfer tax is 2.075%. Your lender will provide a detailed Closing Disclosure at least three days before settlement.",
  },
  {
    question: "Why is a home inspection so important?",
    answer:
      "A home inspection reveals hidden issues with a property's structure, systems, and safety that aren't visible during a showing. In Philadelphia's older housing stock, this step is especially critical — inspectors often uncover outdated electrical, plumbing issues, or foundation concerns. The inspection report gives you leverage to negotiate repairs or credits before you commit to the purchase.",
  },
  {
