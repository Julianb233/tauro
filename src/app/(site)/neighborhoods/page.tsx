...
export default async function NeighborhoodsPage() {
  ...
  return (
    <>
      ...
      <section className="relative bg-foreground pt-32 pb-16"><div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-black/30" /><div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8"><p className="font-label text-sm font-semibold uppercase tracking-[0.25em] text-gold">Explore Philadelphia</p><h1 className="mt-3 font-heading text-4xl font-bold text-white sm:text-5xl md:text-6xl">Philadelphia Neighborhoods</h1><p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">From the tree-lined streets of Rittenhouse to the creative energy of Fishtown — discover what makes each neighborhood unique with Tauro&apos;s local expertise.</p></div></section>
