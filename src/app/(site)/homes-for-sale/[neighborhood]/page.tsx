    ...
    <>
      ...
      <section className="relative min-h-[55vh] overflow-hidden pt-16">
        ...
        <div className="relative z-10 mx-auto flex min-h-[55vh] max-w-7xl flex-col justify-end px-4 pb-14 sm:px-6 lg:px-8">
          <nav className="mb-6 flex items-center gap-2 text-sm text-white/95">
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-medium text-white/95 backdrop-blur-sm">
